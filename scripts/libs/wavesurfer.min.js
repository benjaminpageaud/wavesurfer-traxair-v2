...
WaveSurfer.create = function(a) {
    ...
    createScriptNode: function() {
        this.scriptNode = this.ac.createScriptProcessor ? this.ac.createScriptProcessor(this.scriptBufferSize) : this.ac.createJavaScriptNode(this.scriptBufferSize), this.scriptNode.connect(this.ac.destination)
    },
    addOnAudioProcess: function() {
        var a = this;
        this.scriptNode.onaudioprocess = function() {
            var b = a.getCurrentTime();
            b >= a.getDuration() ? a.setState(a.FINISHED_STATE) : b >= a.scheduledPause ? a.setState(a.PAUSED_STATE) : a.state === a.states[a.PLAYING_STATE] && a.fireEvent("audioprocess", b)
        }
    },
    ...
    drawWave: function(a, b) {
        ...
        this.params.normalize && (j = Math.max.apply(Math, a)), this.waveCc.fillStyle = this.params.waveColor, this.progressCc && (this.progressCc.fillStyle = this.params.progressColor), [this.waveCc, this.progressCc].forEach(function(b) {
            if (b) {
                var radius = 2; //width and radius of each peak
                b.beginPath(), b.moveTo(d, g + f);
                for (var c = 0; h > c; c++) {
                    var e = Math.round(a[c] / j * g);
                    //b.lineTo(c * i + d, g + e + f)
                    b.fillRect(c * i + d, g + e + f, radius, -e);
                    b.fill();
                    b.beginPath();
                    b.arc(c * i + d + radius/2, g + e + f, radius/2 * 0.9, 0, 2 * Math.PI, false);
                }
